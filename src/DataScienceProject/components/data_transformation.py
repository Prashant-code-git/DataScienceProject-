...
class DataTransformation:
    ...
    def get_data_transformation_object (self):
        '''
        This function is responsibale for data tranformation 
        '''
        ...
        try:
            ...
            cat_pipeline=Pipeline(steps=[
                ("imputer",SimpleImputer(strategy='Most_frequents')),
                ("one_hot_encoder",OneHotEncoder()),
                ("scaler",StandardScaler(with_mean=False))
            ])
            logging.info(f"Categoriacl column:{categorical_columns}")
    ...
    def initiate_data_transormation(self,train_path,test_path):
            try:
                ...
                logging.info("Reading the train and test filr")
                ...
                logging.info("Applying Preprocessing on traning and test datafreame ")
